//src/Seller/SellerCalculate.jsx
...
const SellerCalculate = ({ user }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col animate-fade-in relative p-4 md:p-8 pb-32 md:pb-32">
      ...
      <div className="flex flex-col flex-1 w-full max-w-[1600px] mx-auto border-2 border-gray-300 bg-white shadow-sm overflow-hidden rounded-2xl relative mb-4">
        ...
        <div className="p-4 md:p-6 flex-1 overflow-y-auto bg-gray-50">
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
            {displayProducts.map(product => {
              ...
              // --- เช็คว่าเป็นสินค้าเรท R-18 หรือไม่ ---
              ...
              return (
                <div 
                  className="bg-white border-2 border-gray-100 rounded-2xl flex flex-col overflow-hidden cursor-pointer hover:scale-105 hover:shadow-xl hover:border-purple-300 transition-all duration-300 group relative" 
                ...
                >
                  ...
                  <div 
                    className="w-full aspect-square bg-purple-100 flex items-center justify-center text-purple-400 text-2xl font-bold border-b border-gray-100 bg-cover bg-center group-hover:scale-105 transition-transform relative" 
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <div className="flex justify-end items-end mt-auto w-full">
                      <div className="flex items-center border-2 border-purple-200 rounded-lg bg-white max-w-full relative z-10">
                        <button
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t-[3px] border-purple-500 shadow-[0_-4px_15px_-1px_rgba(0,0,0,0.1)] z-50">
        <div className="max-w-[1600px] mx-auto p-4 md:px-8 flex flex-row justify-between items-center w-full">
          
          <div className="flex flex-col md:flex-row items-start md:items-center gap-0 md:gap-2">
            <span className="text-sm md:text-3xl font-bold md:font-black text-gray-500 md:text-gray-900 leading-none mb-0.5 md:mb-0">
              {t('total')}
            </span>
            <span className="text-2xl md:text-3xl font-black text-purple-500 leading-none">
              ฿{totalAmount}
            </span>
          </div>
          ...
          <div className="flex gap-2 sm:gap-3 md:gap-4">
            <button 
              className="bg-blue-300 text-white px-4 sm:px-6 py-2 md:px-8 md:py-3 rounded-xl text-sm sm:text-base md:text-lg font-bold hover:bg-blue-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm" 
            ...
            <button 
              className="bg-green-300 text-white px-4 sm:px-6 py-2 md:px-8 md:py-3 rounded-xl text-sm sm:text-base md:text-lg font-bold hover:bg-green-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm" 
