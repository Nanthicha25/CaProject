                    ...
                    <div key={item.id} className={`p-4 border-b border-gray-100 last:border-0 flex flex-col md:grid md:grid-cols-12 md:gap-2 md:items-center transition-colors ${isDisabled ? 'bg-gray-50/50' : 'bg-white'}`}>
                      ...
                      <div className="flex flex-col gap-3 mt-3 pl-7 md:pl-0 md:mt-0 md:contents">
                        <div className="flex items-end justify-between md:contents">
                          ...
                          <div className="md:col-span-1 md:order-6 text-right md:text-center shrink-0 ml-auto md:ml-0 hidden md:block">
                            <button onClick={() => deleteItem(item.id)} className="text-red-500 hover:bg-red-50 transition text-xs font-bold md:font-medium bg-red-50 md:bg-transparent px-3 py-1.5 md:px-0 md:py-0 rounded-lg">
                              {t('deleteBtn')}
                            </button>
                          </div>
                        </div>
        ...
        <div className="max-w-6xl mx-auto p-4 md:px-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center justify-between w-full md:w-auto md:flex-1 md:justify-start md:gap-4 border-b md:border-0 pb-3 md:pb-0">
            <label className="flex items-center gap-2 cursor-pointer group">
              ...
              <span className="text-gray-700 font-medium group-hover:text-pink-500 transition text-sm md:text-base">{t('selectAll')} ({cartItems.length})</span>
            </label>
